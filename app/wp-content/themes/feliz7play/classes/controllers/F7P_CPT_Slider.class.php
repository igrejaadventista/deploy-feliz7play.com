...
class SliderCPT {
	public function __construct(){
		...
		add_action( 'init', [$this, 'create_slider_cpt'], 0 );  
	}
	
	function create_slider_cpt() {

		$labels = array(
			'name'                  => _x( 'Sliders', 'Post Type General Name', 'f7p' ),
			'singular_name'         => _x( 'Slider', 'Post Type Singular Name', 'f7p' ),
			'menu_name'             => __( 'Slider', 'f7p' ),
			'name_admin_bar'        => __( 'Slider', 'f7p' ),
